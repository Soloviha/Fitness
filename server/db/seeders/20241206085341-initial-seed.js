  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('Exercises', [
      ...
      // Тренировка 5 (workoutId: 5)
      {
        name: 'Канат',
        description:
          'Упражнение с канатом развивает силу, выносливость и координацию. Встаньте на ширине плеч, держите канат обеими руками и быстро поднимайте и опускайте его, создавая волны.',
        time: 30,
        reps: 14,
        relax: 30,
        workoutId: 5,
        isPublic: true,
        picture:
          'http://localhost:3000/img1/gif.mp4',
      },
      {
