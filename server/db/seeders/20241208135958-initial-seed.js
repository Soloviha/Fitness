...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('Chats', [
      ...
      {
        question: 'Что нужно сделать, чтобы начать тренироваться?',
        response:
          'Для начала тренировки Вы можете перейти по кнопке "Тренировки" вверху заголовке страницы. Далее выберите уровень сложности и необходимый комплекс упражнений.',
      },
    ]);
  },
